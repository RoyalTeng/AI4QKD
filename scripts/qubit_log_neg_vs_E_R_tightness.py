...
from qkdx.numerics.e_r_upper import e_r_dephasing
...
def main():
    ...
    with open(out_csv, "w", newline="") as f:
        ...
        for t, ln_dp, kd_dp, ln_de, er_de in zip(ts, log_neg_dp, K_D_dp, log_neg_de, E_R_de):
            w.writerow([
    ...
    print(f"  {'p':>6} {'dp_log_neg':>12} {'dp_K_D':>10} {'gap_dp':>10} {'de_log_neg':>12} {'de_E_R':>10} {'gap_de':>10}")
    for p in [0.05, 0.10, 0.20, 0.30, 0.40, 0.50, 0.60, 2/3, 0.80]:
        ...
        print(f"  {p:6.4f} {ln_dp:12.6f} {kd_dp:10.6f} {ln_dp - kd_dp:10.6f} {ln_de:12.6f} {er_de:10.6f} {ln_de - er_de:10.6f}")
